    ...
    <>
      <section className="py-24 border  ">
        <article className="max-w-7xl text-center mx-auto  space-y-4">
          ...
          <p className="md:text-lg text-sm">Document Sheet is a one-stop solution for all your document management needs. We provide customized solutions for various industries, ensuring that your documents are organized, secure, and accessible when you need them.</p>
        </article>
