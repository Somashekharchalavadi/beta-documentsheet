      ...
      <div className="min-h-screen">
        ...
        <div className="md:mx-36 md:py-12  pb-20 pt-6 leading-relaxed px-4 md:text-lg text-sm text-justify">
          ...
          <ul>
            ...
            <li className="text-base">
              <strong>Place:</strong> To record the location where the document is used.
            </li>
            <li className="text-base">
              <strong>Reason:</strong> To log the purpose of the document sheet usage.
            </li>
            <li className="text-base">
              <strong>Date:</strong> To maintain accurate usage records.
            </li>
          </ul>
          <p className="text-base mt-2">
            <strong>Note:</strong> We do not collect or use cookies to store any data.
          </p>
