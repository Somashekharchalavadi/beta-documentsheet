  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        <Banner title={'Terms and Conditions of Use'} text={'Read our terms and conditions for more details.'} />
        ...
        <div className="md:mx-36 md:py-12  pb-20 pt-6 leading-relaxed px-4 md:text-lg text-sm text-justify">
          ...
          <p className="text-base">
            Document Sheet company operates in strict adherence to <strong>TRADE MARK REGISTRATION OF LOGO (TMR: 3213846)</strong> and are officially recognized under <strong>KPSS - GOVT REGISTRATION OF SOCIETY</strong> with committee <strong>Tarao NO: 625, 626, 628, 629</strong>. This regulation was implemented in compliance with{' '}
            <strong>CENTRAL VIGILANCE COMMISSION</strong>.
          </p>

          <p className="text-base">
            Our document sheets are not stamp papers but serve as Supportive Documents in legal documentation. We comply with all government regulations, including <strong>GST Registration</strong> and <strong>MSME Registration</strong>, ensuring legitimacy and reliability.
          </p>

          <p className="text-base">
            We are also registered for <strong>"The Integrity Pledge"</strong> with <strong>REG NO: 9326297452</strong> for Document Sheet.
          </p>
          ...
          <ul>
            <li>
              👉🏻 Users who do not utilize a purchased document sheet can return it within <strong>7 days</strong> and receive a <strong>90% refund</strong>, provided that complete and valid information is submitted.
            </li>
          ...
          <ul>
            <li>
              👉🏻 Customers can purchase a <strong>Document Sheet Package</strong> for <strong>INR 100</strong>, which includes five high-quality document sheets and a fireproof and waterproof storage file.
            </li>
          ...
          <p>
            <strong>Thank you for choosing Document Sheet. This association has contributed to develop this product in this business</strong>
          </p>
        </div>
      </div>
    </>
