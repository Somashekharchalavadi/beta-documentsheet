  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Read our refund policy to understand the terms for returning unused document sheets and refund processing."
        />
        <meta
          name="keywords"
          content="refund policy, document sheet refund, return policy, digital documents"
        />
      ...
      <div className="min-h-screen">
        <Banner title={'Refund Policy'} text={'Read our terms and conditions for more details.'} />
